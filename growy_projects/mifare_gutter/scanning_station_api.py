...
initGutter_post_args.add_argument("RFID", type=str, help="RFID is required")
initGutter_post_args.add_argument("gutterType", type=str, help="Type of gutter...")
initGutter_post_args.add_argument("gutterNetWeight", type=str, help="GutterNetWeight..")
